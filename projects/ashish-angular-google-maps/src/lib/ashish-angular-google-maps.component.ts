...
// @Component({
//   selector: 'lib-ashish-angular-google-maps',
//   template: `
//     <p>
//       ashish-angular-google-maps works!
//     </p>
//   `,
//   styles: [
//   ]
// })
@Component({
  selector: 'ashish-angular-google-maps',
  templateUrl: './ashish-angular-google-maps.component.html',
  styleUrls: ['./ashish-angular-google-maps.component.css']
})

export class AshishAngularGoogleMapsComponent implements OnInit {
  @Input() latLong: any = {};
  nMap: any = {};
  divId: string = '';
